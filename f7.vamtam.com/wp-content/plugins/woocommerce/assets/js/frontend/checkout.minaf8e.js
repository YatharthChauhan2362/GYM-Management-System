  ...
  var f = {
      ...
      init_payment_methods: function () {
        ...
        1 === e.length && e.eq(0).hide(),
          f.selectedPaymentMethod &&
            g("#" + f.selectedPaymentMethod).prop("checked", !0),
      ...
      payment_method_selected: function (e) {
        e.stopPropagation(),
          1 < g(".payment_methods input.input-radio").length
            ? ((t = g("div.payment_box." + g(this).attr("ID"))),
              (e = g(this).is(":checked")) &&
                !t.is(":visible") &&
      ...
      toggle_create_account: function () {
        g("div.create-account").hide(),
          g(this).is(":checked") &&
            (g("#account_password").val("").trigger("change"),
      ...
      maybe_update_checkout: function () {
        var e,
          t = !0;
        !g(f.dirtyInput).length ||
          ((e = g(f.dirtyInput)
            .closest("div")
            .find(".address-field.validate-required")).length &&
            e.each(function () {
          ...
          ("validate" !== e && "change" !== e) ||
            ...
            n &&
              ...
              ((a = new RegExp(
                ...
                (c = !1))),
            r &&
              ((a = new RegExp(/[\s\#0-9_\-\+\/\(\)\.]/g)),
              0 < t.val().replace(a, "").length &&
                (o
                  .removeClass("woocommerce-validated")
      ...
      update_checkout_action: function (e) {
        ...
        f.xhr && f.xhr.abort(),
          0 !== g("form.checkout").length &&
            ...
            (h = r = g(":input#billing_address_2").val()),
            (l = g(f.$checkout_form).find(
            ...
            g("#ship-to-different-address").find("input").is(":checked") &&
              ...
              (h = g(":input#shipping_address_2").val())),
            !(h = {
                    ...
                    g(".payment_box :input").each(function () {
                      ...
                      e &&
                        ...
                        g.inArray(g(this).attr("type"), ["checkbox", "radio"])
                          ? (t[e] = g(this).prop("checked"))
                          : (t[e] = g(this).val()));
                    }),
                    e &&
                      e.fragments &&
                      (g.each(e.fragments, function (e, t) {
                        (f.fragments && f.fragments[e] === t) ||
                          g(e).replaceWith(t),
                          g(e).unblock();
                      }),
                    ...
                    g.isEmptyObject(t) ||
                      g(".payment_box :input").each(function () {
                        ...
                        e &&
                          (-1 !==
                          g.inArray(g(this).attr("type"), ["checkbox", "radio"])
                            ? g(this).prop("checked", t[e]).trigger("change")
                            : (-1 !==
                                g.inArray(g(this).attr("type"), ["select"]) ||
                                (null !== g(this).val() &&
                                  0 === g(this).val().length)) &&
                              g(this).val(t[e]).trigger("change"));
                      }),
                    e &&
                      "failure" === e.result &&
                      ((o = g("form.checkout")),
        ...
        return (
          o.is(".processing") ||
            (!1 !== o.triggerHandler("checkout_place_order") &&
              !1 !==
                o.triggerHandler(
                  "checkout_place_order_" + f.get_payment_method()
                ) &&
              ...
              g.ajax({
                ...
                success: function (e) {
                  ...
                  try {
                    if (
                      "success" !== e.result ||
                      !1 === o.triggerHandler("checkout_place_order_success", e)
                    )
    ...
    e = {
      ...
      remove_coupon: function (e) {
        ...
        var o = { security: wc_checkout_params.remove_coupon_nonce, coupon: e };
        g.ajax({
          type: "POST",
          url: wc_checkout_params.wc_ajax_url
            .toString()
          ...
          success: function (e) {
            g(".woocommerce-error, .woocommerce-message").remove(),
              ...
              e &&
                ...
                g(document.body).trigger("removed_coupon_in_checkout", [
                  o.coupon_code,
                ]),
                g(document.body).trigger("update_checkout", {
                  update_shipping_method: !1,
